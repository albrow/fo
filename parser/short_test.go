...
var valids = []string{
	...
	`package p; func _(x [5]int) { for range x {} }`,
	`package p; func _([]int, []string) { }`,
	`package p; func _([2]int, [3]string) { }`,
	`package p; func _([...]int, [...]string) { }`,
	...
	// Type declarations
	`package p; type T[V] V`,
	`package p; type T[V] struct { v V }`,
	`package p; type T[U, V] map[U]V`,
	`package p; type T struct{ U[V] }`,
	`package p; type T struct{ a U[V]; b U[V]; }`,

	// Function and method declarations
	`package p; func f[T] (t T) {}`,
	`package p; func f[T, U] (t T, u U) {}`,
	`package p; func f[T] () T {}`,
	`package p; func (t T) f[T] () {}`,
	`package p; func (t T) f[T, U, V] (u U) V {}`,
	...
	// Top-level variable assignments and declarations
	`package p; var _ T[U]`,
	`package p; var _ = T[U]{}`,
	`package p; var _ *T[U]`,
	`package p; var _ = &T[U]{}`,
	`package p; var _ []T[U]`,
	`package p; var _ = []T[U]{}`,
	`package p; var _ [2]T[U]`,
	`package p; var _ = [2]T[U]{}`,
	`package p; var _ map[T[U]]V[W]`,
	`package p; var _ = map[T[U]]V[W]{}`,
	`package p; var _ chan T[U]`,
	`package p; var _ = make(chan T[U])`,
	`package p; var _ func(T[U])`,
	`package p; var _ = func(T[U]) {}`,
	`package p; var _ func() T[U]`,
	`package p; var _ = func() T[U] {}`,
	`package p; var _ y.T[U]`,
	`package p; var _ = y.T[U]{}`,
	`package p; var _ T[interface{}, chan <-int, struct{}, map[int]string]`,
	`package p; var _ = T[interface{}, chan <-int, struct{}, map[int]string]{}`,
	`package p; var _ T[[]int]`,
	`package p; var _ = T[[]int]{}`,
	`package p; var _ = f[[]int]`,
	`package p; var _ = f[[]int, []string]`,
	`package p; func _() { f[T]() }`,
	`package p; func _() { f[T, U]() }`,
	`package p; var _ T[bytes.Buffer, io.Writer]`,
	`package p; var _ = T[bytes.Buffer, io.Writer]{}`,
	`package p; var _ T[U[string, int], V[bool]]`,
	`package p; var _ = T[U[string, int], V[bool]]{}`,
...
var invalids = []string{
	...
	`package p; func _()(x, y, z ... /* ERROR "expected type, found '...'" */ int){}`,
	...
	`package p; type T[V struct /* ERROR "expected '\]', found 'struct'" */ { val: "" }`,
	`package p; type T[V, ] /* ERROR "expected 'IDENT', found '\]'" */ struct { val: "" }`,
