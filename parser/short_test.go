...
var invalids = []string{
	...
	`package p; func f::() /* ERROR "expected type, found '\)'" */  () { val V }`,
	`package p; func f::(V ( /* ERROR "expected '\)', found '\('" */ ) { val V }`,
	`package p; func f::(V, ) /* ERROR "expected type, found '\)'" */ () { val V }`,
	...
	`package p; func:: /* ERROR "expected 'IDENT', found '::'" */ (T) (T) f(U) () {}`,
